    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex flex-col min-h-screen bg-gray-50 p-4 md:p-6">
        <div className="max-w-xl w-full mx-auto bg-white rounded-lg shadow p-6 space-y-6">
          <h1 className="text-2xl font-bold text-center text-[#05014A]">{isEdit ? 'Edit Customer' : 'Add New Customer'}</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4" autoComplete="off">
            ...
            <div className="mt-8 flex justify-end">
              ...
              >
                ...
                {loading ? (isEdit ? 'Updating...' : 'Saving...') : (isEdit ? 'Update Customer' : 'Add Customer')}
              </button>
            </div>
          </form>
        </div>
