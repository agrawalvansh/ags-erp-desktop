...
const BuyerAccountDetail = () => {
  ...
  const handleDownloadLedger = () => {
    try {
      ...
      if (buyer.mobile) doc.text(`Mobile: ${buyer.mobile}`, margin + 80, 22);
      if (buyer.address) doc.text(`Address: ${buyer.address.substring(0, 60)}`, margin + 80, 27);
      ...
      doc.setFontSize(11);
      doc.setFont('helvetica', 'bold');
      doc.text('Maal (Sales)', margin, startY);
      ...
      doc.save(`Ledger_${buyer.name || slug}_${new Date().toISOString().split('T')[0]}.pdf`);
